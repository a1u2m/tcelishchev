package com.example.developerslife.fragments;
...
import com.example.developerslife.adapters.GifPicsAdapter;
import com.example.developerslife.databinding.FragmentGifViewBinding;
import com.example.developerslife.interfaces.CardStackSimpleListener;
...
public class GifStateFragment extends Fragment implements CardStackSimpleListener {
    ...
    public static final String ARGS_STACK_TYPE = "ARGS_STACK_TYPE";
    ...
    public void onCardRewound() {
        if (binding.progressBar.getVisibility() == View.VISIBLE && layoutManager.getTopPosition() == gifReferences.size() - 1) {
            handleLoadingIndicator(false);
            handleError(false);
